        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupRatings_Criteria_CriterionId",
            ...
            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "Id", "EndDate", "IsClosed", "IsPublic", "Name", "StartDate" },
                values: new object[] { 1, new DateTime(2023, 10, 31, 23, 59, 59, 0, DateTimeKind.Unspecified), false, false, "+Devs2Blu HackWeek 2023", new DateTime(2023, 10, 31, 0, 0, 1, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "EventId", "Name", "PasswordHash", "Role", "Username" },
                values: new object[] { 1, null, "Admin", "$2a$11$5IhaBFx0uo2dYGZKT5tCUeGaa8A2W7HIeP2nhF5D.Ts9PRRCoFtqO", "admin", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupRatings_CriterionId",
                table: "GroupRatings",
                column: "CriterionId");
